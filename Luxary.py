...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Ahad-chowdhury-007/MR-AHAD/blob/main/Appruvel.txt').text
        ua=open('bbnew.txt','w')
...
os.system('xdg-open https://www.facebook.com/arafatyou248?mibextid=ZbWKwL')
logo =(f"""
\x1b[38;5;46m88888b. db    db d888888b db   dD d888888b 
\x1b[38;5;46m88  `8D 88    88 `~~88~~' 88 ,8P'   `88'   
\x1b[38;5;46m88oodD' 88    88    88    88,8P      88    
\x1b[38;5;46m88~~~   88    88    88    88`8b      88    
\x1b[38;5;46m88      88b  d88    88    88 `88.   .88.   
\x1b[38;5;46m88      ~Y8888P'    YP    YP   YD Y888888P 
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Ahad-chowdhury-007/MR-AHAD/blob/main/Appruvel.txtt').text
    if id in httpCaht:
      print(fuckyoursali)
...
#while attemps < 12345677901:
 #     username = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER USERNAME: ')
  ...
  #  if username == 'ARAFAT' and password == '63':
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/ARAFAT.King.Ok.Bro")
    if hc in ['1','01']:
